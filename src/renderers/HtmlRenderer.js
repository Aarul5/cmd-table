...
var HtmlRenderer = /** @class */ (function () {
    ...
    HtmlRenderer.prototype.render = function (table) {
        ...
        var bodyRows = table.rows
            .map(function (row) {
            return "<tr>".concat(visible.map(function (item) { var _a, _b; return "<td>".concat(escapeHtml((_b = (_a = row.cells[item.index]) === null || _a === void 0 ? void 0 : _a.getString()) !== null && _b !== void 0 ? _b : ''), "</td>"); }).join(''), "</tr>");
        })
            .join('');
